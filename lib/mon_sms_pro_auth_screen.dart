...
class MonSmsProAuthScreen extends StatefulWidget {
  final String apiKey;
  ...
  @override
  State<MonSmsProAuthScreen> createState() => _MonSmsProAuthScreenState();
}

class _MonSmsProAuthScreenState extends State<MonSmsProAuthScreen> {
  ...
  Future<bool> _sendOTP() async {
    try {
      ...
      if (widget.demoPhoneNumber != null &&
        ...
        if (otp.success) {
          setState(() => _token = otp.data?.token);
        }
